...
if(tortoiseLocationX==505&&tortoiseLocationY==300) {
	JOptionPane.showMessageDialog(null, "Go to the pirate hat" );
}
if(tortoiseLocationX==405&&tortoiseLocationY==235) {
	JOptionPane.showMessageDialog(null, "go to the big skull");
}
if(tortoiseLocationX==140&&tortoiseLocationY==40) {
	JOptionPane.showMessageDialog(null, "go to the fat parrot" );
}
if(tortoiseLocationX==140&&tortoiseLocationY==40) {
	JOptionPane.showMessageDialog(null, "go the the big skull" );
